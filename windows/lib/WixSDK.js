...
WixSDK.prototype.generateMSI =
    function(app_path, xwalk_path, meta_data, callback) {
        ...
        var app_root_folder = program_files_folder.ele('Directory', { Id: 'ApplicationRootFolder', 'Name': meta_data.app_name });
        // We're putting web app files to a separate subfolder to avoid name clashes.
        var app_files_folder = app_root_folder.ele('Directory', { Id: 'ApplicationFilesFolder', 'Name': app_root_path });
        // Try to align with the in-folder extensions' directory name of Android.
        var app_relative_extensions_dir = 'xwalk-extensions';
        var app_extensions_folder = app_root_folder.ele('Directory', { Id: 'ApplicationExtensionsFolder', 'Name': app_relative_extensions_dir });
        var program_menu_folder = target_dir.ele('Directory', { Id: 'ProgramMenuFolder' });
        var app_menu_folder = program_menu_folder.ele('Directory', { Id: 'ApplicationProgramsFolder', 'Name': meta_data.app_name });
